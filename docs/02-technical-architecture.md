...
| 4 | 180s | لا إقرار | بطاقة الموظف تنبض: "نادِ #247 بالاسم" + تُعرض القنوات التي وصلت |
...
- **الطلب الذكي للإذن:** لا نطلب إذن Push فور الفتح. نعرض الزر "نبّهني على الجوال"، وعند الضغط نطلب الإذن. على iOS بدون تثبيت: الزر يشرح "أضف الصفحة للشاشة الرئيسية لتصلك التنبيهات" أو يعرض واتساب كبديل (V2).
- **Service Worker:** يستقبل Push ويعرض إشعارًا بعنوان "دورك! طلب 247 جاهز" ويفتح `/o/:token?call=1` عند الضغط.
